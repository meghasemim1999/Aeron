...
//    public static final String PONG_CHANNEL = "aeron:udp?endpoint=172.16.30.103:20126";
    ...
    public static void main(final String[] args) throws InterruptedException
    {
        ...
        final Aeron.Context ctx = new Aeron.Context().availableImageHandler(MyPing::availablePongImageHandler);
        final FragmentHandler fragmentHandler = new FragmentAssembler(MyPing::pongHandler);
    ...
    private static void roundTripMessages(
        ...
        for (long i = 0; i < count; i++)
        {
            ...
            System.out.println(offeredPosition);
